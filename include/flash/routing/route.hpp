...
// Deliberately not constexpr: GCC 16.2 mis-folds this routine when a reflected
// inline route object is passed at runtime (compiler repro tracked in ADR 0002).
